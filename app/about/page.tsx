                        ...
                        <div className="lg:w-1/3 p-6 md:p-8 lg:p-12 flex flex-col justify-between min-h-[300px] lg:min-h-[400px]">
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="w-16 h-16 shrink-0 rounded-sm border border-black/10 bg-black/[0.02] flex items-center justify-center shadow-sm relative overflow-hidden">
                                    {/* Optional: Hier kannst du später ein Foto als <img /> einfügen */}
                            ...
                            <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3 mt-12">
                                <a
                                    href="mailto:contact@pytja.com"
                                    className="flex-1 px-6 py-3.5 bg-black text-white text-[11px] font-bold uppercase tracking-[0.2em] rounded-md hover:bg-gray-800 transition-colors text-center shadow-sm"
                                >
                                    Contact
                                </a>
                                <a
                                    ...
                                    className="flex-1 px-6 py-3.5 border border-black/10 bg-white text-black text-[11px] font-bold uppercase tracking-[0.2em] rounded-md hover:bg-black/[0.02] hover:border-black/20 transition-all text-center"
                                >
                                    GitHub
                                </a>
                            </div>
