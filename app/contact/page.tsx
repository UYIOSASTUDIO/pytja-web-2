                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-10 divide-y lg:divide-y-0 lg:divide-x divide-black/10 max-w-[1600px] mx-auto px-0 md:px-12 lg:px-24">
                        ...
                        <div className="lg:col-span-4 p-6 md:p-8 lg:p-12 flex flex-col bg-black/[0.01]">
                            ...
                            <div className="pb-6 md:pb-12">
                                ...
                                <Link href="/legal/privacy" className="group inline-flex items-center gap-2 text-[13px] font-medium text-black transition-all w-fit border-b border-black/20 pb-0.5 hover:text-gray-600 hover:border-gray-600">
                            ...
                            <div className="pt-8 border-t border-black/10 space-y-4 -ml-[50vw] pl-[50vw] -mr-6 md:-mr-8 lg:-mr-12 pr-6 md:pr-8 lg:pr-12">
                                ...
                                <div className="p-5 md:p-6 bg-white border border-black/10 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] relative overflow-hidden group/board">
                                    ...
                                    <a href="https://github.com/pytja/pytja/discussions" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.1em] text-black transition-all hover:text-gray-500 relative z-10 border border-black/10 bg-black/[0.02] hover:bg-black/[0.04] px-4 py-2 rounded-md">
                                        Join Discussion
                                        <svg className="w-3.5 h-3.5 transform transition-transform duration-300 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                ...
                                <a href="https://github.com/pytja" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 p-4 border border-black/10 bg-white hover:border-black/10 hover:shadow-md transition-all rounded-lg">
                                    ...
                                    <div>
                                        <div className="text-[10px] uppercase tracking-[0.1em] text-gray-400 font-bold mb-0.5">Source Code</div>
                                        <div className="text-[13px] font-mono text-black">github.com/pytja</div>
                                    </div>
                                </a>

                                {/* LinkedIn */}
                                <a href="https://www.linkedin.com/in/eliasschmolke/" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 p-4 border border-black/10 bg-white hover:border-black/10 hover:shadow-md transition-all rounded-lg">
                                    ...
                                    <div>
                                        <div className="text-[10px] uppercase tracking-[0.1em] text-gray-400 font-bold mb-0.5">Business</div>
